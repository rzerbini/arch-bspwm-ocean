...
### Install
```text
sudo pacman -S bspwm sxhkd polybar picom comptom rofi dunst nitrogen i3lock redshift cmus ranger dmenu thunar xorg-xinit kitty xorg-xrandr xorg-xsetroot bash-completion
```
